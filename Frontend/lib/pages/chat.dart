...
import 'package:wealthify_me/components/bubble_normie.dart';
import 'package:wealthify_me/models/message.dart';
import 'package:wealthify_me/services/chat_service.dart';
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  void sendQuickChatMessage(String message) async {
    ...
    try {
      var res = await http.post(
          Uri.parse("https://serval-generous-eagle.ngrok-free.app/query"),
          headers: {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Title(color: Colors.black, child: Text('Finance AI')),
      ),
      body: Column(
        children: [
          const SizedBox(
